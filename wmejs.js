...
wmeList = ["rocket", "honolulu", "bruno", "ladybird", "mocha", "classical", "soliloquy", "zachariah", "tia", "renee", "ciel", "vatra", "ariana", "estella", "adonis", "romulus", "viski", "saline", "godiva", "aleus", "fluffy", "cain", "bailey", "hazel", "snickerdoodle", "caspian", "terracotta", "alsike", "douglas", "phoebe", "jasper", "dew", "polaris", "yorkshire", "acacia", "quincy", "argent", "gnash", "affogato", "solstice", "cheshire", "welsummer", "argyle", "ophelia", "tina", "calliope", "unnamed" ];
